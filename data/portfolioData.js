...
export const contact = { email: 'ishikashakya0123@gmail.com', phone: '+91-8882531022', emailHref: 'mailto:ishikashakya0123@gmail.com', phoneHref: 'tel:+918882531022', heading: "Let’s create something together.", intro: 'Have a brand, campaign or creative idea in mind? Let’s turn it into something visually memorable.' };
...
export const projects = [
 ...
 project('gudr-conquer-peaks','GUDR — Conquer Peaks','Promotional Design','Promotional','Mountain Bike Advertisement','A bold outdoor product composition built around strong typography, dynamic scale and an adventurous visual identity.','gudr-mountain-bike-poster.jpg','GUDR mountain bike promotional poster'),
